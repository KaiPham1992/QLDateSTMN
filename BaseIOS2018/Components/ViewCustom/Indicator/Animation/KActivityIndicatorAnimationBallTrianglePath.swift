//
//  KActivityIndicatorAnimationBallTrianglePath.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationBallTrianglePath: KActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Top-center circle
        let topCenterCircle = KActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-left circle
        let bottomLeftCircle = KActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-right circle
        let bottomRightCircle = KActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
