//
//  KActivityIndicatorAnimationCubeTransition.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationCubeTransition: KActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw squares
        for i in 0 ..< 2 {
            let square = KActivityIndicatorShape.rectangle.layerWith(size: CGSize(width: squareSize, height: squareSize), color: color)
