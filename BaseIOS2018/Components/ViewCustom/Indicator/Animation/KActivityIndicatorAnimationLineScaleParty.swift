//
//  KActivityIndicatorAnimationLineScaleParty.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationLineScaleParty: KActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        for i in 0 ..< 4 {
            let line = KActivityIndicatorShape.line.layerWith(size: CGSize(width: lineSize, height: size.height), color: color)
