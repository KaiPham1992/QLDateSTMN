//
//  KActivityIndicatorAnimationPacman.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationPacman: KActivityIndicatorAnimationDelegate {
    ...
    func pacmanInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw pacman
        let pacman = KActivityIndicatorShape.pacman.layerWith(size: CGSize(width: pacmanSize, height: pacmanSize), color: color)
        let frame = CGRect(
