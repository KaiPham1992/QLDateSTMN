//
//  KActivityIndicatorAnimationBallClipRotateMultiple.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationBallClipRotateMultiple: KActivityIndicatorAnimationDelegate {
    ...
    func circleOf(shape: KActivityIndicatorShape, duration: CFTimeInterval, timingFunction: CAMediaTimingFunction, layer: CALayer, size: CGFloat, color: UIColor, reverse: Bool) {
