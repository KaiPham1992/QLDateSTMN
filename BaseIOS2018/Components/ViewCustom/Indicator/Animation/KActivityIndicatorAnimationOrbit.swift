//
//  KActivityIndicatorAnimationOrbit.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationOrbit: KActivityIndicatorAnimationDelegate {
    ...
    func ring1InLayer(_ layer: CALayer, size _: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = KActivityIndicatorShape.circle.layerWith(size: CGSize(width: coreSize, height: coreSize), color: color)
    ...
    func satelliteInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = KActivityIndicatorShape.circle.layerWith(size: CGSize(width: satelliteSize, height: satelliteSize), color: color)
