//
//  KActivityIndicatorAnimationBallSpinFadeLoader.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationBallSpinFadeLoader: KActivityIndicatorAnimationDelegate {
    ...
    func circleAt(angle: CGFloat, size: CGFloat, origin: CGPoint, containerSize: CGSize, color: UIColor) -> CALayer {
        ...
        let circle = KActivityIndicatorShape.circle.layerWith(size: CGSize(width: size, height: size), color: color)
        let frame = CGRect(
