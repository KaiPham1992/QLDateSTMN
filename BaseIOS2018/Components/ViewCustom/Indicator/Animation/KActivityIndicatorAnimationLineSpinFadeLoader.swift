//
//  KActivityIndicatorAnimationLineSpinFadeLoader.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationLineSpinFadeLoader: KActivityIndicatorAnimationDelegate {
    ...
    func lineAt(angle: CGFloat, size: CGSize, origin: CGPoint, containerSize: CGSize, color: UIColor) -> CALayer {
        ...
        let line = KActivityIndicatorShape.line.layerWith(size: size, color: color)
